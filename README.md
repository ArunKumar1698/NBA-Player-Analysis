🏀 NBA Data Analysis (2024-2025 Season)
...
NBA - Final.ipynb – Jupyter Notebook containing data cleaning, exploratory data analysis (EDA) and player evaluation.
...
Open NBA Stats.csv to view the raw dataset.
Open NBA - Final.ipynb in Jupyter Notebook.
Run all cells to reproduce the analysis.
Review key insights in NBA Data Analysis.pptx.
